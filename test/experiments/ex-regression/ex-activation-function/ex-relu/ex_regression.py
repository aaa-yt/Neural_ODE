...
def main():
    config = {
        ...
        "Function_type": "relu", #sigmoid, relu
        "Optimizer_type": "SGD",
        "Learning_rate": 0.01,
        "Momentum": 0.9,
        "Decay": 0.99,
    ...
    #ex_dir = os.path.join(os.path.join(ex_regression_dir, "ex-activation-function"), "ex-sigmoid")
    ex_dir = os.path.join(os.path.join(ex_regression_dir, "ex-activation-function"), "ex-relu")
