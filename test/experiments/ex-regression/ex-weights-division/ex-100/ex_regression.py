...
def main():
    config = {
        ...
        "Output_dimension": 1,
        "Maximum_time": 1.0,
        "Weights_division": 100, # 50, 67, 83, 100
    ...
    #ex_dir = os.path.join(os.path.join(ex_regression_dir, "ex-weights-division"), "ex-50")
    #ex_dir = os.path.join(os.path.join(ex_regression_dir, "ex-weights-division"), "ex-67")
    #ex_dir = os.path.join(os.path.join(ex_regression_dir, "ex-weights-division"), "ex-83")
    ex_dir = os.path.join(os.path.join(ex_regression_dir, "ex-weights-division"), "ex-100")
